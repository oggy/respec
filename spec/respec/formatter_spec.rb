...
describe Respec::Formatter do
  describe ".extract_spec_location" do
    ...
    it "finds the spec file for normal examples" do
    ...
    it "finds the spec file for shared examples" do
      metadata = {
    ...
    it "warns when no spec file is found, and return the root location" do
